...
public class MainActivity$$ViewInjector {
  public static void inject(Finder finder, final com.example.paydemo.MainActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131296270, "field 'image_goback'");
    target.image_goback = (android.widget.ImageButton) view;
    view = finder.findRequiredView(source, 2131296273, "field 'title'");
    target.title = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131296277, "field 'image_gonext'");
